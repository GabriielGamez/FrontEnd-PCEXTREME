...
async function cargarComponentes() {
    try {
        ...
        const respuestaHeader = await fetch('/FrontEnd-PCEXTREME/components/header.html');
        ...
        const respuestaFooter = await fetch('/FrontEnd-PCEXTREME/components/footer.html');
